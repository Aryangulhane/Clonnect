-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('HELP_REQUEST', 'RESOURCE', 'GENERAL');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MENTION', 'REPLY', 'LIKE', 'FOLLOW', 'MATCH', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "PostTag_tagName_idx" ON "PostTag"("tagName");
